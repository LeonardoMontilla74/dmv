      ...
      <section className={styles.container}>
        <div className={styles.cardAbout}>
          <p>Somos una empresa que ofrece servicios de asesoría sobre seguros, dmv, inspecciones
            ...
            necesidades. Nuestra misión es ayudarte a proteger tu patrimonio y tu tranquilidad,
            ofreciéndote las mejores opciones de cobertura y precio. Estamos comprometidos con la
